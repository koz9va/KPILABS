...
C1 = [15.5e-12, 14.0e-12, 12.2e-12, 10.5e-12, 9.7e-12, 9.0e-12, 8.6e-12, 8.1e-12, 7.6e-12, 7.1e-12, 6.7e-12, 6.4e-12, 6.1e-12];
...
for i = 1:size(Uzv, 2)
    ...
    line(UsvLong, y, 'parent', handler); y = interp1(Usv, I(i, 1:size(Usv, 2)), UsvLong, 'next');
    line(UsvLong, y, 'parent', handler);
